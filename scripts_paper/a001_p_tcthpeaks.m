...
AP.rawExcerpt=              [171.3 172.4]; % good
AP.rawExcerpt=              [132 133.1]; % not too bad
AP.rawExcerpt=              [0 1]+920; % not too bad
AP.rawExcerpt=              [0 1]+972.8; % not too bad
AP.rawExcerpt=              [7.5 9]; % not so great because of small peak amplitudes
AP.rawExcerpt=              [30 31]+24; %
