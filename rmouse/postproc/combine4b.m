...
% and instead combine4b can access auto.mat or cross.mat computed
...
% - rmouse.m: struct array r has become very unwieldy over time (>100 Mb
% for standard experiments), maybe put all fields in separate vars?
...
for rvi=rvix
  ...
  for loopi=1:length(loopP)  
    ...
    if export
      ...
      save([WP.rootPath projSubDir '\export\' fn],'compareFactor','ds1','ds2','mds*','ds1fit','ds2fit','fitx','indv*');
    end
    % -------------------------------------
