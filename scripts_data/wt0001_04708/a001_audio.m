...
AP.rawChAudioNm=             {'IN 6','IN 11'};DS.rawCh([1:end-1],1);

% length of segment
AP.rawAudioExcerpt=          [126 131];'full'; 
AP.rawAudioExcerpt=          [120.3 156]; % 01
AP.rawAudioExcerpt=          [16*60+20-.2   16*60+41]; % 02
AP.rawAudioExcerpt=          [13*60+25-1/3   13*60+37]; % 07
AP.rawAudioExcerpt=          [16*60+14   16*60+42]; % 08
...
AP.wffn='d:\hh\matlab\projects\rmouse\auxil\drum1_mod.wav';
...
% modulation depth (a value between 0 and 1): amplitudes of field potentials will 
% be mapped to frequencies such that peaks correspond to high frequencies and troughs
...
AP.rawChAnNm=               DS.rawCh([1:end-1],1);
